...
(async () => {
  ...
  await shot('dark-initial.png');
  console.log('dark theme:', await ev(`document.documentElement.getAttribute('data-theme') || 'dark'`));

  await ev(`document.getElementById('theme-toggle').click(); true`);
  await sleep(400);
  await shot('light-initial.png');
  console.log('after toggle:', await ev(`document.documentElement.getAttribute('data-theme')`));
  ...
  await sleep(500);
  await shot('light-generated.png');

  await ev(`document.getElementById('theme-toggle').click(); true`);
  await sleep(400);
  await shot('dark-generated.png');
  console.log('DONE');
  process.exit(0);
